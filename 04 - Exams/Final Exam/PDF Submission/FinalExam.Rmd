...
(numNewBuilds_b \times newBuildCost_b) + (numOldBuildsDemod \times demoCost)
\end{bmatrix}
\leq budget
$$
...
$$
share: numNewBuilds_b \geq newBuildPercShare_b \times \sum_{b \in NewBuildTypes} (numNewBuilds_b), 
$$
$$
...
$$
numOldBuildsDemod \geq 0
$$
$$
\ numNewBuilds_b \geq 0, 
