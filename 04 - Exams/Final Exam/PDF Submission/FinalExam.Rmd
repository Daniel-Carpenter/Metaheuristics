...
* Below shows the path relinking overview.
* Similar calculations as aboce, just choosing the best neighbor with minimal positional distance
between then current and guided solution

![](Images/problem2ii.png)

\newpage
## *Part iii*: Path Relinking
