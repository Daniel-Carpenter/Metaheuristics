...
**C4:** For all products ($p\in PRODUCTS$), the weighted-average grade of fruit is greater than the minimum required grade. Note $Prooducts$ is abbreviated as $P$   
$minAvgGrade:$
$$
\begin{pmatrix}
\frac{produce_{f=1,\ p}} {\sum_{p\in P}(produce_{f,p})} \times avgGradeOfFruit_{f=1}
\end{pmatrix} 
$$
$$
+ \begin{pmatrix}
\frac{produce_{f=2,\ p}} {\sum_{p\in P}(produce_{f,p})} \times avgGradeOfFruit_{f=2}
\end{pmatrix}
$$
$$
\geq	avgGradeOfFruit_f
$$
