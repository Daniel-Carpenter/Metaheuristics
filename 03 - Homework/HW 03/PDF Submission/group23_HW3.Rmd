...
$M_{p,s}$      | Variable to map *decision variable* $tonsOfProduct_{p,s}$ to $isStored_{p,s}$. Uses big M method.
...
$$
mapVars: tonsOfProduct_{p,s} \leq M_{p,s} \times isStored_{p,s}
